...
def upload_file():
    ...
    if not credentials:
        flash("Ошибка аутентификации. Пожалуйста, войдите снова.", "danger")
        return redirect(url_for('login'))
        
    # Инициализация UIAnalysisAgent с учетными данными
    # Эта строка должна быть здесь, а не глобально
    ui_agent = UIAnalysisAgent(credentials=credentials) 
